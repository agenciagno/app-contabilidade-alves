 ...
 *
 * Vive num componente próprio porque aparece em dois lugares: na aba
 * "Dados da Empresa" de Configurações (equipe interna da CA) e dentro de
 * "Minha Conta" (cliente externo, que não tem Configurações).
 */
